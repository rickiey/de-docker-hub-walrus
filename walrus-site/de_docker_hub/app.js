...
function searchAPI(query) {
    ...
    const apiUrl = `https://rickiey.xyz/hub/search?q=${query}`
...
function displayResults(hits) {
    ...
    hits.forEach((hit) => {
        ...
        card.innerHTML = `
            ...
            <p><strong>blob-id:</strong> <a class="underline underline-offset-2" href='https://aggregator-devnet.walrus.space/v1/${hit.blob_id}'  download='${hit.image_tag}.tar'> ${hit.blob_id}</a></p>
        `
